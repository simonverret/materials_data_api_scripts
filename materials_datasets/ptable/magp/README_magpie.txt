...
in "covalent_radius" in the first row and row 98+ I had to manually replace the 0.2 by 0.0
in "atomic_masses" the first row was 1.00000. I replaced it by 0.0 
